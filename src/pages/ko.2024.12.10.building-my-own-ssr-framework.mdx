  ...
  return {
    layout: {
      ...
      openGraph: {
        ...
        description:
          '최종 목표는, 예를 들어 Next.js와 같이 SSR 프레임워크처럼 동작하는 것을 만들어 보는 것이었는데, 마침내 어제 처음 설정했던 목표를 달성했습니다. 프레임워크라 부르기엔 부족하지만, 개인이 취미로 만들어 개인적으로 사용하기엔 충분히 만족스러운 결과물이라고 생각합니다.',
        images: [{ url: '/assets/posts/building-my-own-ssr-framework.webp' }],
      },
    },
  };
};

<img src="/assets/posts/building-my-own-ssr-framework.webp" style={{ height: '300px', width: '100%', objectFit: 'cover' }} />
