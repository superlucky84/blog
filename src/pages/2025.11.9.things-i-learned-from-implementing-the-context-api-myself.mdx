...
React essentially took that concept of “scope” and applied it to the UI tree level.
...
const AppProvider = xmount((_renew, _props, children) => {
...
And I’m also happy that my virtual DOM library, [lithent](https://github.com/superlucky84/lithent), now has another solid feature added to it.
