...
"> There are already other series available: [Building My Own Custom React](https://subtleflo.com/ko/2022/9/4/my-custom-react-creation) , [Creating My Own SSR Framework](https://subtleflo.com/ko/2024/12/10/building-my-own-ssr-framework).
...
To combine the characteristics of the signal pattern and the Lens pattern, we utilized [Proxy](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Proxy)
